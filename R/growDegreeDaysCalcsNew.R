  ...
  for (l in startyearChoices) {
    for (i in modelChoices)  {
      ...
      for (m in cropChoices) {
        ...
        endTime <- Sys.time()
        print(paste0("tmax_cropArea created, ", temp, ", creation time: ", endTime -startTime,  ", pid: ", Sys.getpid()))
        ...
        endTime <- Sys.time()
        print(paste0("tmax_clamped created, ", temp, ", creation time: ", endTime -startTime,  ", pid: ", Sys.getpid()))
        ...
        endTime <-  Sys.time()
        print(paste0("tmin_clamped created, ", temp, ", creation time: ", endTime -startTime,  ", pid: ", Sys.getpid()))
        ...
        gddFunction <- function(x, y) {(x + y)/2 - Tbase}
        
        startTime <-  Sys.time()
        gdd <- overlay(x = tmax_clamped, y = tmin_clamped, fun = gddFunction)
         endTime <-  Sys.time()
        print(paste0("gddTemp created, ", "creation time: ", endTime -startTime,  ", pid: ", Sys.getpid()))

...
varietiesChoiceSuffix <- "_main" # whether to use lo, main, or hi cp values. Needs to be before the sourcing code next
...
sumTable_main_flex_area <- add_footer(sumTable_main_flex_area, Species = "This is a note in footer" )
